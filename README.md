...
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | The instance type for the vSensors. This can be one of t3.medium, m5.large, m5.2xlarge, m5.4xla. | `string` | `"t3.medium"` | no |
